...
const KNOWN_DOCS: Record<string, { title: string; description: string }> = {
  ...
  'CONTRIBUTING.md': { title: 'CONTRIBUTING.md', description: 'Guía para contribuidores humanos y de IA.' },
  'CHANGELOG.md': { title: 'CHANGELOG.md', description: 'Historial de cambios del proyecto.' },
