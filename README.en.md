...
When you select **Kiro** as a target in the decision tree, the bundle includes these files under `.kiro/`. The schemas validating these artifacts live in `src/kiro/schemas/*.json` and are verified on every release.
