      ...
      <div role="status" aria-live="polite" className="text-center">
        <div className="mx-auto mb-5 flex w-fit gap-2">
          {[0, 1, 2].map((index) => (
            <span
              key={index}
              className="h-3 w-3 rounded-full bg-emerald-500 animate-pulse-dot"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-6 text-zinc-100">
      ...
      >
        ...
        <button onClick={initialize} className="mt-6 rounded-lg bg-red-700 px-5 py-2.5 font-medium hover:bg-red-600">
          Reintentar
        </button>
      </div>
    </div>
