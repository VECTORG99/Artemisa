        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="space-y-6">
              ...
              <ol className="mt-4 space-y-3 text-sm text-zinc-300">
                {bundle.applicationGuide.steps.map((step, index) => (
                  <li key={step} className="flex gap-3">
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-zinc-800 text-xs text-emerald-400">
                      {index + 1}
                    </span>
                    <span>{step}</span>
                  </li>
            ...
            <button
              ...
              disabled={loading}
              aria-busy={loading}
              className="w-full rounded-xl border border-zinc-700 px-5 py-3 font-medium text-zinc-300 hover:bg-zinc-900 disabled:cursor-not-allowed disabled:opacity-50"
            >
