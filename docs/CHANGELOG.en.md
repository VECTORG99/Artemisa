...
- Add PROMPT.md artifact and display it on the completion screen (#668) _(generator)_

### Other

- Reorganize final review into explanation on top, decisions below (#666) _(creator)_

## [v1.1.1] - 2026-07-27

### Bug Fixes

- Remove v prefix from git-cliff to prevent double-v tags (#661) _(ci)_
...
- Remove v prefix from git-cliff to prevent double-v tags _(ci)_
...
- Accent color only changes on truly different hover targets _(ui)_

- Remove dotenv and Pino from tech stack badges _(landing)_

- Change accent color on hover, not on a timer _(ui)_
...
- Redesign docs page with sidebar navigation and inline GitHub rendering (#611) _(docs)_
...
- Assign different RGB palette color to each accent surface _(ui)_

- Add brand colors to tech stack badges _(landing)_
...
- A11y, perf, SEO and polish (#579, #580, #570, #581) (#595) _(frontend)_

- QuickStartCopy textarea, tilde and unique announcement (#554, #572) (#587) _(frontend)_
...
- Repair e2e/eval infrastructure, LLM provider compatibility, workspace docs (#380)

- Integration test supports problem+json error format (#347) _(test)_

- Final quality batch — stack-specific docs, VPS recommendation, problem+json, compact evaluate (#344) _(creator)_

- Quality enhancements — personalized steering, dynamic security, architecture recommendations (#343) _(creator)_

- 4 critical generation bugs — RAG patterns, MCP configuration, INSTALL.md (#342) _(creator)_
...
- Strengthen debug routes — remove replay, restrict info, add TTL (#299) _(security)_

- Strengthen admin bypass — request-scoped, timing-safe, audited (#298) _(security)_

- Enforce role isolation on memory API (#297) _(security)_

- Strengthen pipeline endpoint with server-side limits (#296) _(security)_
...
- Productionize agent-creator — replace Vite dev server with static serve (#115) _(docker)_

- Frontend fallback to correct backend URL on Render (#114) _(deploy)_

- Restrict CORS origins and protect /api/metrics (#103) _(security)_- Harden Docker config — resource limits, secrets exclusion, NODE_ENV (#102) _(devops)_
...
- Automate changelog with git-cliff in releases
...
- V0.1.0 _(release)_- Implement pre-commit hooks with husky + lint-staged (#112)
...
- API reference, troubleshooting, self-hosting and apply-bundle (#576, #577) (#590)

- Fix broken instructions and note CHANGELOG post-Runtime (#573, #578) (#589)

- Document ephemeral agent environment variables in README (#529)

- Disable GitHub Wiki and document where docs live (#370)

- Disable GitHub Wiki and document where docs live (#370)- Add SVG diagrams and screenshots to README and agent-creator (#358)

- Add SVG diagrams and screenshots to README and agent-creator (#358)

- Add READMEs to monorepo subprojects

- Add READMEs to monorepo subprojects

- Correct SDK and project root licenses

- Correct SDK and project root licenses

- Add community documentation and guide for human contributors

- Add community documentation and guide for human contributors

- Clean obsolete documentation and add script docs

- Clean obsolete documentation and add script docs

- Documentation infrastructure (templates, SEO, versions, funding)- Documentation infrastructure (templates, SEO, versions, funding)

- Renew main README with hackathon context, homepage, and badges
...
- Expand implementation plan into a complete hackathon sprint roadmap- Add Huascar title to README
...
- Toggle animations and smooth scroll (#559, #388) (#607) _(landing+creator)_

- Official documentation path + endpoint for AI models (#560) (#600)
...
- Machine-friendly endpoint for AI agents + 'Huascar startup' protocol _(api/creator)_
...
- Minimalist landing page, liquid glass, and MPL-2.0 license (#315) _(frontend)_
...
- Frontend test infrastructure with Vitest + RTL (#153) _(testing)_
...
- Add pino structured logging (#54) (#122)- Require authentication for protected API routes (#106) _(security)_
...
- Remove expired Runtime documentation (#597) _(other)_

- Reposition Huascar as file generator (#582) (#592) _(other)_

- Final screen with ZIP, fixed steps, and default tab (#567) (#588) _(creator)_
...
- Deduplicate in-flight evaluate requests + last-result memo (#513) _(creator)_
...
- Extract configuration and security policy into declarative files
