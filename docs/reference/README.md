...
Artemisa genera archivos de configuración; no ejecuta agentes. Este directorio contiene ejemplos y guías de referencia para los artefactos que produce el Creator.
