...
Artemisa permite disenar y generar configuracion de agentes de desarrollo y operacion mediante un arbol de decisiones determinista.
...
- Generar configuracion target para Artemisa, Kiro o portable.
- Documentar por que se eligio cada pieza del stack (`docs/WHY.md` generado).

## Fuera de alcance

Artemisa no ejecuta agentes: no hay motor ReAct, LLM, RAG, MCP ni base de datos (#584).
...
- Usuarios de Kiro y Artemisa que buscan un creador visual de configuraciones.
